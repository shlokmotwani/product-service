...
//    @GetMapping("/partial")
//    public ResponseEntity<List<ProductWithTitleAndPrice>> getAllProductsWithTitleAndPrice(){
//        ResponseEntity<List<ProductWithTitleAndPrice>> response = null;
//        try {
//            List<ProductWithTitleAndPrice> products = this.productService.getAllProductsWithTitleAndPrice();
//            response = new ResponseEntity<>(products,
//                    HttpStatus.OK);
//        }
//        catch(Exception e){
